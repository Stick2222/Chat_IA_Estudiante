...
import { inscripcionService } from "../api/inscripcionapi";
import type { Inscripcion } from "../models/models";
...
const MisCursos: React.FC = () => {
  ...
  // Resto del componente igual hasta la parte de renderizado...
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        <span className="text-sm text-gray-500">
                          Paralelo{" "}
                          {inscripcion.paralelo?.numero_paralelo || "N/A"}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-600">
                          Materia:{" "}
                          {inscripcion.paralelo?.materia?.nombre ||
                            "No asignada"}
                        </span>
                      </div>
